...
# total bs=80
CUDA_VISIBLE_DEVICES=$cuda_visible torchrun --standalone --nnodes=1 --nproc_per_node=$NUM_GPUS test_load_distil_ckp.py \
    --do_distil \
    ...
    --save_total_limit 5 \
    --seed 42 \
    --distil_resume_from_checkpoint ${run_dir}/output/fedllm/distilled/emulators/${MODEL}_${num_student_layers}_${pad}_${pad}/checkpoint-${ckp_step}
